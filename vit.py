...
class Vit(nn.Module):
    ...
    def forward (self, images):
        n, c, h, w = images
        patches = patch_embedding(images, self.n_patches)  # n, 49, 16
        ...
        pos_embed = self.pos_embedding.repeat(n, 1, 1) # n, 50, 8
...
def positional_embedding(sequence_lenght, d): # 50, 8
...
class MultiHeadAttention (nn.module):
    ...
    def forward (self, sequences):
        # n , seq_length, token_dim, #n, 50, 8/d_heads
        # patch 8/head, each patch will have q, k, v
        ...
        for sequence in sequences:
            ...
            for head in range (self.n_heads): # 0, 1
                ...
                #watchout for possible error here
